...
class ExternalMessage(Base):
    ...
    sender_username: Mapped[str|None]=mapped_column(String(255)); sender_first_name: Mapped[str|None]=mapped_column(String(255)); sender_last_name: Mapped[str|None]=mapped_column(String(255))
...
class CalendarEvent(Base):
    ...
    __table_args__=(UniqueConstraint("integration_connection_id","idempotency_key",name="uq_calendar_events_connection_idempotency_key"),)
