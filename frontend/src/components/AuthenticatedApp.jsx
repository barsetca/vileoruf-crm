...
function AuthenticatedApp() {
  ...
  useEffect(() => {
    if (!["/crm", "/crm/clients", "/crm/deals", "/crm/pipeline", "/crm/tasks", "/crm/ai-history", "/crm/settings/business", "/crm/settings/ai", "/crm/settings/integrations"].includes(pathname) || (["/crm/settings/business", "/crm/settings/ai", "/crm/settings/integrations"].includes(pathname) && user.role !== "ADMIN")) {
